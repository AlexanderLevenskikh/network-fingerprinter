...
import { i18UserNsRuResources } from 'root/i18n/resources/user/ru';
import { i18UserNsUsResources } from 'root/i18n/resources/user/us';
...
export const i18UsResources = {
    ...
    [ I18nNamespace.user ]: i18UserNsUsResources,
};
